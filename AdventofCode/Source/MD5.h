...
#define II(a, b, c, d, x, s, ac) { \
  ...
  private:
    ...
    // a multiple of 4.
    constexpr static void Encode(unsigned char* output, UINT4* input, unsigned int len)
    {
      unsigned int i, j;
    ...
    // a multiple of 4.
    constexpr static void Decode(UINT4* output, const unsigned char* input, unsigned int len)
    {
      unsigned int i, j;
  ...
  public:
    ...
    void Update(
      ...
      size_t inputLen) noexcept // length of input block
    {
    ...
    constexpr void writeToString() noexcept
    {
